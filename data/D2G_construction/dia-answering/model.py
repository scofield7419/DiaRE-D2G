...
class Model(BertPreTrainedModel):
    def __init__(self, config, lstm_hidden_size=128, lstm_num_layers=2, gcn_layer=1, mylstm_hidden_size=128,
                 num_decoupling=1):
        ...
        self.BiLSTM = nn.LSTM(config.hidden_size, self.lstm_hidden_size, self.lstm_num_layers, bias=True,
    ...
    def forward(
        ...
        pooled_output = self.pooler_activation(
            self.pooler(final_lstm_output))  # (batch_size, num_chioce, 4*mylstm_hidden_size )
